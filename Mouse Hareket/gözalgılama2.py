...
DOUBLE_BLINK_MAX_GAP = 0.65 # iki kırpma arası max süre (s)
...
class GazeMapper:
    def __init__(self):
        ...
        self.sent_pos = (SCREEN_W // 2, SCREEN_H // 2)  # son gönderilen konum
    ...
    def map(self, features, blinking=False):
        ...
        # Ölü bölge: DEAD_ZONE pikselden küçük hareketleri yoksay.
        # Kalman'ı da sent_pos'a sabitle — yoksa içeride drift eder ve
        # dead zone açılınca büyük sıçrama yapar.
