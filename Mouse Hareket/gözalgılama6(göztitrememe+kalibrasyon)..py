...
CAL_WAIT    = 1.8   # göz stabilize olsun (s)
CAL_COLLECT = 3.0   # örnek toplama (s)
CAL_RIDGE   = 0.02  # Ridge regülasyon — polinom taşmasını önler
EAR_BLINK   = 0.17  # bu değerin altında göz kapalı sayılır

DEAD_ZONE            = 3    # piksel — bu kadardan küçük hareketler yok sayılır
DOUBLE_BLINK_MAX_GAP = 1.5  # iki kırpma arası max süre (s) — 1.5s pencere
GAZE_X_OFFSET        = -5    # negatif = imleç sola kayar; sağa kayma varsa negatif yap (örn. -40)
GAZE_Y_OFFSET        = 0    # pozitif = imleç aşağı kayar; yukarı kayma varsa pozitif yap
